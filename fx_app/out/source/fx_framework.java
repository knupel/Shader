...
public class fx_framework extends PApplet {
...
*/
public void setup_fx_post_on_g() {
	select_input();
}



public void draw_fx_post_on_g(PImage img_1, PImage img_2, PImage pattern_1, PImage pattern_2) {
...
public void setup_fx_post_on_tex() {
	select_input();
}

public void draw_fx_post_on_tex() {
	set_movie(input_path());
	set_img(input_path());
  if(img_input != null) {
...
public PGraphics fx_toon(PImage source, boolean on_g) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "fx_framework" };
    if (passedArgs != null) {
